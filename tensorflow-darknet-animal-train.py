...
sess = tf.Session()
model1 = model_darknet19(sess=sess, name="animal-darknet19", class_count=classCount, learning_rate=0.001)
...
for epoch in range(train_epoch):
    ...
    for i in range(total_batch):
        inputs_train, outputs_train = loader_train.load([100*100*3], 255, batch_size)
    ...
    inputs_validation, output_validation = loader_validation.load([100*100*3], 255, validationCount)
