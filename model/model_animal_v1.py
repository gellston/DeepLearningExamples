...
class model_animal_v1:
    ...
    def _build_net(self):
        ...
        with tf.variable_scope(self.name):
            ...
            # Layer2
            W2 = tf.Variable(tf.random_normal([6, 6, 64, 64], stddev=0.01))
            ...
            # Layer4
            W4 = tf.Variable(tf.random_normal([5, 5, 128, 128], stddev=0.01))
            ...
            drop_layer4 = tf.nn.dropout(pool_layer4, keep_prob=self.keep_layer)
